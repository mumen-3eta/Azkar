...
List<Map<String, dynamic>> data = [
  ...
  {
    "Azkir": {
      "Azkir": "أَعـوذُ بِكَلِمـاتِ اللّهِ التّـامّـاتِ مِنْ شَـرِّ ما خَلَـق",
      "Repetition": 3
    }
  },
  {
    "Azkir": {
      "Azkir": "اللَّهُمَّ صَلِّ وَسَلِّمْ وَبَارِكْ على نَبِيِّنَا مُحمَّد",
      "Repetition": 10
    }
  },
  {
  ...
  {
    "Azkir": {"Azkir": "سُبْحـانَ اللهِ وَبِحَمْـدِهِ.", "Repetition": 100}
  },
  {
    "Azkir": {"Azkir": "أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ", "Repetition": 100}
  }
  //

  ,
];
List<AzkarReapond> AzkrList =
    data.map((e) => AzkarReapond.fromjson(e)).toList();
